          ...
          <div className="px-8 pt-5">
              ...
              <div className="relative inline-block mb-4">
                <div
                  className={`absolute inset-0 blur-2xl rounded-full scale-150 animate-pulse ${
                    accent === 'amber' ? 'bg-amber-500/15' : 'bg-blue-500/15'
                  }`}
                />
                <img
                  src="/logooo.jpeg"
            ...
            <div className="grid grid-cols-2 p-1 rounded-2xl mb-5 h-11 relative overflow-hidden border border-white/10 bg-white/5">
              <button
                ...
                className={`relative z-10 flex items-center justify-center gap-2 text-[10px] font-black uppercase tracking-widest rounded-xl transition-all duration-500 ${
                  role === 'user' ? 'text-white' : 'text-white/60 hover:text-white/80'
                }`}
                type="button"
              >
              ...
              <button
                ...
                className={`relative z-10 flex items-center justify-center gap-2 text-[10px] font-black uppercase tracking-widest rounded-xl transition-all duration-500 ${
                  role === 'driver' ? 'text-white' : 'text-white/60 hover:text-white/80'
                }`}
                type="button"
              >
              ...
              <div
                className={`absolute inset-y-1 w-[calc(50%-4px)] rounded-xl transition-all duration-500 ease-out ${
                  role === 'driver'
                    ? `bg-amber-600 shadow-md shadow-amber-600/20 ${
                        isRTL ? 'translate-x-[calc(-100%-2px)]' : 'translate-x-[calc(100%+2px)]'
                      }`
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <button
                disabled={loading}
                type="submit"
                className={`w-full h-12 mt-1 relative group overflow-hidden text-white font-black rounded-2xl transition-all active:scale-[0.98] uppercase tracking-[0.2em] text-[10px] border border-white/10 ${
                  role === 'driver'
            ...
            <div className="mt-5 text-center pb-4">
              <p className="text-white/60 font-bold text-xs tracking-wide">
                ...
                <button
                  ...
                  className={`ml-2 text-white border-b border-white/20 hover:border-white/70 transition-all font-black ${
